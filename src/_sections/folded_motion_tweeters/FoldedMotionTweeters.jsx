  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 sm:px-6 px-6 sm:space-y-6 mb-6 lg:mt-6 mt-6">
      <div className="relative overflow-hidden rounded-xl lg:h-[35rem]">
        ...
        <div className="px-6 lg:px-0 absolute inset-x-0 bottom-0 pb-6 items-end sm:flex sm:items-center sm:justify-end lg:inset-y-0 lg:inset-x-auto lg:w-[33rem] lg:flex-col lg:items-end">
