...
const RecentReviews = () => {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl lg:max-w-7xl lg:px-8 px-6">
            ...
            >
              <div className="lg:col-span-8 lg:col-start-5 xl:col-span-9 xl:col-start-4 xl:grid xl:grid-cols-3 xl:items-start xl:gap-x-8">
                ...
                <div className="mt-4 lg:mt-6 xl:col-span-2 xl:mt-0">
                  ...
                  <div
                    className="font-body mt-3 space-y-6 text-sm text-gray-500"
              ...
              <div className="mt-6 flex items-center  lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:mt-0 lg:flex-col lg:items-start xl:col-span-3">
                ...
                <time
                  ...
                  className="text-sm font-body ml-4 border-l border-gray-200 pl-4 text-gray-500 lg:ml-0 lg:mt-2 lg:border-0 lg:pl-0"
                >
                  {review.date}
                </time>
              </div>
