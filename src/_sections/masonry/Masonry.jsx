  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="font-heading lg:text-5xl text-3xl font-bold text-center mt-16">
          Gallery
        </div>
      </div>
      ...
      <section className="relative sm:px-6 mt-16" id="masonry-grid">
        ...
        <div class="wrapper">
          <a class="grid-image" href="#img1" style={{ paddingTop: "0px" }}>
            <img
              alt="image 1"
              src="https://cdn.pmlsound.com/martinlogan/Motion_Series/Motion-Shoot-004-tv-retouched.png"
            />
          </a>
          ...
          <a class="grid-image" href="#img3">
            <img
              alt="image 3"
              src="https://cdn.pmlsound.com/martinlogan/Motion_Series/Motion-Shoot-014-tv-touched-up.png"
            />
          </a>
          <a class="grid-image" href="#img4">
            <img
              alt="image 3"
              src="https://cdn.pmlsound.com/martinlogan/Motion_Series/Motion-Shoot-015-tv-touched-up.png"
            />
          </a>
          <a class="grid-image" href="#img5">
            <img
              alt="image 3"
              src="https://cdn.pmlsound.com/martinlogan/Motion_Series/Motion-Shoot-018-tv-touched-up.png"
            />
          </a>
          ...
          <a class="grid-image" href="#img7">
            <img
              alt="image 3"
              src="https://cdn.pmlsound.com/martinlogan/Motion_Series/Motion-Shoot-017-tv-touched-up.png"
            />
          </a>
